        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-6">
          ...
          <div className="space-y-4">
            ...
            <div className="relative">
              ...
              {/* Search results list INSIDE the relative parent */}
              {searchResults.length > 0 && (
                <div className="border border-slate-100 rounded-lg max-h-[200px] overflow-y-auto divide-y bg-white shadow-lg absolute z-20 left-0 right-0 top-full mt-1 p-1">
                  {searchResults.map(u => (
