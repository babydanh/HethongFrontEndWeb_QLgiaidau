    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 gap-6 xl:grid-cols-2">
        ...
        <div className="rounded-2xl border border-indigo-200 bg-indigo-50/70 p-5 shadow-sm">
          <div className="flex items-start justify-between gap-4">
            <div>
              <p className="text-xs font-bold uppercase tracking-[0.18em] text-indigo-700">Đội 2</p>
              <h4 className="mt-2 text-xl font-bold text-slate-900">{team2Name}</h4>
            </div>
            <div className="min-w-[92px] rounded-lg bg-white px-4 py-3 text-center shadow-sm">
              <p className="text-[11px] font-bold uppercase tracking-[0.16em] text-slate-400">Pha bóng</p>
              <p className="mt-1 text-4xl font-bold tabular-nums text-indigo-700">{currentPointTeam2}</p>
            </div>
          </div>
          ...
          <div className="mt-5 grid gap-3 sm:grid-cols-2">
            <button
              ...
              disabled={isSubmitting || !match.participant1Id || !match.participant2Id}
              className="rounded-lg bg-indigo-600 px-4 py-4 text-left text-white shadow-md transition-all hover:bg-indigo-700 disabled:opacity-50"
            >
