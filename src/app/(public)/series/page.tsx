    ...
    <div className="bg-slate-50 min-h-screen text-slate-900 font-sans selection:bg-blue-100 selection:text-blue-900">
      ...
      <div className="relative bg-slate-900 overflow-hidden py-16 md:py-24 border-b border-slate-800">
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8 relative z-10 text-center flex flex-col items-center">
          ...
          <h1 className="text-3xl md:text-5xl font-black text-white tracking-tight mb-4 max-w-3xl leading-tight font-sans">
      ...
      <main className="max-w-7xl mx-auto px-4 md:px-8 py-10">
        ...
        <div className="flex flex-col md:flex-row gap-4 items-center justify-between mb-8 bg-white p-4 rounded-2xl border border-slate-200 shadow-sm">
          ...
          <div className="relative w-full md:w-80">
            ...
            <input
              ...
              className="w-full bg-slate-50 border border-slate-200 rounded-xl py-2.5 pl-10 pr-4 text-sm focus:bg-white focus:border-blue-600 focus:ring-2 focus:ring-blue-100 transition-all outline-none"
            />
          </div>
        ...
        {isLoading ? (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {[1, 2, 3].map((n) => (
              <div key={n} className="bg-white rounded-2xl border border-slate-200 overflow-hidden flex flex-col h-[400px] animate-pulse">
          ...
          <div className="text-center py-20 bg-white rounded-2xl border border-red-200 max-w-xl mx-auto p-8 text-red-500">
          ...
          <div className="text-center py-20 bg-white rounded-2xl border border-slate-200 border-dashed max-w-xl mx-auto flex flex-col items-center justify-center p-8">
