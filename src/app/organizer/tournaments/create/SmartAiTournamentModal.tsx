  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm animate-fadeIn">
      <div className="relative w-full max-w-3xl bg-white rounded-2xl shadow-2xl border border-slate-100 overflow-hidden flex flex-col max-h-[90vh]">
        {/* Header */}
        <div className="flex items-center justify-between px-6 py-4 border-b border-slate-100 bg-gradient-to-r from-blue-600 to-indigo-700 text-white">
          <div className="flex items-center gap-2.5">
            <div className="p-2 bg-white/15 rounded-lg backdrop-blur-md">
              <Sparkles className="w-5 h-5 text-amber-300 animate-pulse" />
            </div>
            <div>
              <h3 className="font-bold text-lg leading-tight">Tạo giải đấu thông minh với AI &amp; Excel</h3>
              ...
              <div className="flex items-center justify-between pt-2">
                <div className="flex items-center gap-2">
                  ...
                  <select
                    ...
                    className="text-xs font-medium bg-slate-100 border border-slate-200 rounded-lg px-2.5 py-1 text-slate-700 focus:outline-none"
                  >
            ...
            <div className="space-y-6 animate-fadeIn">
              <div className="p-4 bg-blue-50/60 border border-blue-100 rounded-xl space-y-3">
                <div className="flex items-start justify-between">
                  <div>
                    <span className="inline-block px-2 py-0.5 bg-blue-600 text-white font-bold text-[10px] rounded uppercase tracking-wider mb-1">
                      {parsedData.sport}
                    </span>
              ...
              {excelResult && (
                <div className="p-3.5 bg-emerald-50/60 border border-emerald-100 rounded-xl space-y-2">
                  ...
                  <div className="max-h-32 overflow-y-auto border border-emerald-200/60 rounded-lg bg-white p-2">
          ...
          {step === 1 ? (
            <>
              ...
              <button
                ...
                className="flex items-center gap-2 px-5 py-2.5 bg-blue-600 hover:bg-blue-700 disabled:opacity-50 text-white text-xs font-bold rounded-xl shadow-sm transition-all"
              >
                {isAnalyzing ? (
                  <>
            ...
            <>
              ...
              <button
                ...
                disabled={isCreating}
                className="flex items-center gap-2 px-6 py-2.5 bg-emerald-600 hover:bg-emerald-700 disabled:opacity-50 text-white text-xs font-bold rounded-xl shadow-md transition-all"
              >
                {isCreating ? (
                  <>
                    <Loader2 className="w-4 h-4 animate-spin" />
