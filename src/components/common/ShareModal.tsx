...
export default function ShareModal({ isOpen, onClose, shareUrl, title, shareText, fbAppId }: ShareModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      {/* Modal Card */}
      <div className="relative w-full max-w-lg overflow-hidden rounded-lg border border-slate-100 bg-white p-6 text-slate-900 shadow-2xl transition-all duration-300 transform scale-100 mx-4">
        ...
        <div className="mt-5 grid grid-cols-4 gap-2.5">
          ...
          >
            <div className="flex h-9 w-9 items-center justify-center rounded-full bg-[#0068ff] font-bold text-white text-[11px] transition-all group-hover:scale-105 shadow-sm">
              Zalo
            </div>
            <span className="text-[10px] font-semibold text-slate-700">Zalo</span>
          </button>

          {/* Facebook */}
          <button
            onClick={() => openSharePopup(getFacebookShareUrl(shareUrl))}
            className="flex flex-col items-center justify-center gap-2 rounded-lg border border-slate-100 bg-slate-50/60 py-3.5 px-1.5 transition-all hover:-translate-y-0.5 hover:border-blue-300 hover:bg-blue-50/30 group cursor-pointer"
          >
          ...
          <button
            ...
            className="flex flex-col items-center justify-center gap-2 rounded-lg border border-slate-100 bg-slate-50/60 py-3.5 px-1.5 transition-all hover:-translate-y-0.5 hover:border-pink-200 hover:bg-pink-50/30 group cursor-pointer"
          >
            ...
            <span className="text-[10px] font-semibold text-slate-700">Messenger</span>
          </button>
          ...
          >
            ...
            <span className="text-[10px] font-semibold text-slate-700">Telegram</span>
          </button>
          ...
          >
            ...
            <span className="text-[10px] font-semibold text-slate-700">Twitter X</span>
          </button>
          ...
          >
            <div className="flex h-9 w-9 items-center justify-center rounded-full bg-slate-900 text-white transition-all group-hover:scale-105 shadow-sm">
              <span className="font-bold text-[12px] italic tracking-tight">Th.</span>
            </div>
            <span className="text-[10px] font-semibold text-slate-700">Threads</span>
          </button>
          ...
          {supportNativeShare && (
            ...
            >
              ...
              <span className="text-[10px] font-semibold text-emerald-650">{translate('nativeShare')}</span>
            </button>
          )}
        </div>
        ...
        <div className="mt-6 border-t border-slate-100 pt-5">
          ...
          <div className="flex items-center gap-2 rounded-lg bg-slate-50 p-2 border border-slate-100 focus-within:border-emerald-500/30 focus-within:bg-white focus-within:ring-2 focus-within:ring-emerald-100 transition-all">
            ...
            <button
              ...
              className={`flex shrink-0 items-center justify-center gap-1.5 rounded-lg px-4 py-2 text-xs font-semibold transition-all duration-250 active:scale-[0.97] cursor-pointer shadow-sm ${
                copied 
