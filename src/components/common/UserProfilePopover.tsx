    ...
    >
      ...
      <div className="relative px-4 pb-4 pt-0">
        ...
        <div className="min-w-0">
          ...
          {communityId && (
            <div className="mt-3 rounded-xl border border-blue-200/80 bg-blue-50/50 p-2.5 space-y-2">
              <div className="flex items-center justify-between">
                ...
                {profileData.streak?.count && profileData.streak.count > 0 ? (
                  <span
                    className={`inline-flex items-center gap-1 px-2 py-0.5 rounded text-[10.5px] font-mono font-bold border shadow-2xs ${
                  ...
                  <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded text-[10.5px] font-mono font-bold bg-emerald-50 text-emerald-700 border border-emerald-200 shadow-2xs">
                    <Flame className="w-3 h-3" />
                    Chuỗi W{userClubRank.winStreak}
                  </span>
                ) : (
                  <span className="text-[10px] font-mono text-slate-400">Chưa có chuỗi</span>
                )}
              </div>

              {/* Club ELO & Match Telemetry */}
              <div className="grid grid-cols-2 gap-2 pt-0.5">
                <div className="rounded-lg bg-white p-2 border border-blue-100 shadow-2xs">
                  <p className="text-[9.5px] font-bold uppercase text-slate-400">Điểm ELO CLB</p>
                  <p className="text-sm font-black font-mono text-blue-700">
                    {userClubRank?.eloPoints ? `${userClubRank.eloPoints} ELO` : "Chưa xếp rank"}
                  </p>
                </div>
                <div className="rounded-lg bg-white p-2 border border-blue-100 shadow-2xs">
                  <p className="text-[9.5px] font-bold uppercase text-slate-400">Trận trong CLB</p>
          ...
          {/* ELO Tier Badges for each sport with Smart Overflow (World/Public Rank) */}
