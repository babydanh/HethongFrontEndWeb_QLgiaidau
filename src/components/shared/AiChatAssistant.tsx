          ...
          >
            ...
            <div className="h-[60px] shrink-0 bg-blue-600 flex items-center justify-between px-4">
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  <p className="text-white font-extrabold text-[13px] leading-tight flex items-center gap-1">
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-4 bg-white min-h-0">
              {messages.map((msg, index) => (
                ...
                >
                  <div
                    className={`w-7 h-7 rounded-full flex items-center justify-center shrink-0 text-[11px] font-bold shadow-sm ${
                      msg.role === 'user'
                  ...
                  <div
                    className={`max-w-[78%] px-3.5 py-2.5 rounded-2xl text-[12.5px] leading-relaxed shadow-sm border ${
                      msg.role === 'user'
              ...
              {isLoading && (
                <div className="flex gap-2.5 items-start">
                  ...
                  <div className="bg-slate-50 border border-slate-100 px-4 py-3 rounded-2xl rounded-tl-sm flex items-center gap-1.5 shadow-sm">
              ...
              <div className="px-4 py-2.5 bg-white border-t border-slate-100 shrink-0">
                ...
                <div className="flex flex-col gap-1">
                  {QUICK_PROMPTS.map((prompt, idx) => (
                    ...
                    >
                      <span className="font-bold truncate">{prompt}</span>
            ...
            <div className="p-3 bg-white border-t border-slate-100 flex items-center gap-2 shrink-0">
              <textarea
                ...
                rows={1}
                className="flex-1 resize-none max-h-20 px-3 py-2 rounded-xl border border-slate-200 bg-slate-50 text-slate-800 text-[12.5px] outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/10 transition-all placeholder:text-slate-400"
              />
              <button
